# Contributing to SWIFT-TestBed3
...
This section guides you through submitting a bug report. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behaviour :computer: :computer:, and find related reports :mag_right:.
 ...
 Fill in [the bug report template](https://github.com/cemac/Swift-Testbed3/issues/new/choose)
...
* **If the problem started happening recently,** can you reproduce the problem in an older version? [the releases page](https://github.com/cemac/SWIFT-Testbed3/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.
* **Is the problem related to a certain set of data?**

Include details about your configuration and environment:

* **Which software version are you using?** e.g. what does `python --version` return if it a python error
* **What's the name and version of the OS you're using**? We highly recommend using UNIX

### Feature Requests

This section guides you through submitting an enhancement suggestion for the SWIFT Testbed3 repository, including completely new features and minor improvements to existing functionality. Following these guidelines helps maintainers and the community understand your suggestion :pencil: and find related suggestions :mag_right:.

When you are creating an enhancement suggestion, please include as many details as possible. Fill in [the feature request template](https://github.com/cemac/Swift-Testbed3/issues/new/choose), including the steps that you imagine you would take if the feature you're requesting existed.

#### Before Submitting An Enhancement Suggestion

* **Check a functions help**  *If it's a bash or python tool usually `-h` will return some help
